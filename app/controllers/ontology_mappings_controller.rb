  ...
  def create
    ...
    respond_to do |format|
      if @ontology_mapping.save
        format.html { redirect_to(@ontology_mapping, :notice => 'Ontology mapping was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @ontology_mapping.update_attributes(params[:ontology_mapping])
        format.html { redirect_to(@ontology_mapping, :notice => 'Ontology mapping was successfully updated.') }
        format.xml  { head :ok }
      else
